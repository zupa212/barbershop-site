...
const StoreHours = ({ showOnlyPanorama = false, showOnlyThermi = false, showOnlyKalamaria = false }) => {
  ...
  const panoramaHours = [
    ...
    { day: "Τρίτη", time: "9:00 π.μ. - 5:00 μ.μ." },
    { day: "Τετάρτη", time: "9:00 π.μ. - 5:00 μ.μ." },
    { day: "Πέμπτη", time: "9:00 π.μ. - 5:00 μ.μ." },
    { day: "Παρασκευή", time: "9:00 π.μ. - 5:00 μ.μ." },
  ...
  const handleGetThermiDirections = () => {
    window.open(
      "https://www.google.com/maps/dir/?api=1&destination=Καραολή+και+Δημητρίου+4+Εμπορικό+LA+PIAZZA+Θέρμη+Θεσσαλονίκη",
      "_blank"
    );
  };
